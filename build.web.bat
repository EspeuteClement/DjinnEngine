...
set FLAGS= -s USE_WEBGL2=1 -s USE_GLFW=2 -s ALLOW_MEMORY_GROWTH=1 -s ASSERTIONS=2 -s TOTAL_MEMORY=134217728 -g4 --source-map-base http://localhost:8000/build/ -std=c++11
